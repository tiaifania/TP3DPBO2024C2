...
$form = '<form action="aksi_tambah.php?tabel=matakuliah" method="POST" enctype="multipart/form-data>
<div class="mb-3">
    <label for="nama" class="form-label">Nama Mata Kuliah</label>
    <input type="text" class="form-control" id="nama" name="mataKuliah_nama" required>
</div>
...
$view->replace('DATA_TITLE', 'Tambah Mata Kuliah');
$view->replace('DATA_FORM_LABEL', 'Mata Kuliah');
